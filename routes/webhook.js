...
const { sendEmail, formatContactEmail, formatServiceEmail, formatEmergencyEmail } = require('../utils/emailService');
...
router.post('/email', async (req, res) => {
  try {
    ...
    if (action !== 'INSERT') {
      ...
      return res.json({ success: true, message: 'Ignored non-INSERT operation' });
    }
